...
import 'package:xmppstone/src/ConnectionStateChangedListener.dart';
...
import 'package:xmppstone/src/roster/RosterListener.dart';
    ...
    if (xmppElement != null &&
      ...
      xmppElement.children.forEach((child) {
        if (child.name == 'item') {
          ...
          buddy.subscriptionType =
              Buddy.typeFromString(subscriptionString);
